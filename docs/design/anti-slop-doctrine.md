...
4. **Type:** one family, IBM Plex Sans, for display, body, and UI. Use weight (700/600 vs 400) and size for hierarchy. Body and UI text stay at least 16px (1rem). Do not add a second face.
